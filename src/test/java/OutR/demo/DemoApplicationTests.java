...
class DemoApplicationTests {
	...
	void coordinates() {
		...
		MatcherAssert.assertThat(stockholm.convertCoordinates(vasaParkenN, vasaParkenE), CoreMatchers.allOf(
				CoreMatchers.containsString("59.33907"),
				CoreMatchers.containsString("18.04053")
		));
		MatcherAssert.assertThat(stockholm.convertCoordinates(testValueN, testValueE), CoreMatchers.allOf(
